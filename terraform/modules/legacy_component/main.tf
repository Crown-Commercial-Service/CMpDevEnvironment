...
locals {
    ...
    legacy_config_app_domain = "${data.aws_ssm_parameter.domain_name.value}"
    legacy_config_api_domain = "${data.aws_ssm_parameter.domain_prefix.value}.${data.aws_ssm_parameter.domain_name.value}"
