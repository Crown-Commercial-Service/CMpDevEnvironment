...
data "aws_ssm_parameter" "legacy_domain_name" {
  name = "/${var.environment_name}/config/legacy_domain_name"
}
...
data "aws_ssm_parameter" "legacy_db_config_url" {
  name = "/${var.environment_name}/config/legacy_rds_url"
}

data "aws_ssm_parameter" "legacy_db_config_type" {
  name = "/${var.environment_name}/config/legacy_rds_type"
}

data "aws_ssm_parameter" "legacy_db_config_host" {
  name = "/${var.environment_name}/config/legacy_rds_host"
}

data "aws_ssm_parameter" "legacy_db_config_port" {
  name = "/${var.environment_name}/config/legacy_rds_port"
}

data "aws_ssm_parameter" "legacy_redis_config_host" {
  name = "/${var.environment_name}/config/legacy_redis_host"
}

data "aws_ssm_parameter" "legacy_redis_config_port" {
  name = "/${var.environment_name}/config/legacy_redis_port"
}

data "aws_ssm_parameter" "legacy_db_config_name" {
  name = "/${var.environment_name}/config/legacy_rds_name"
}

data "aws_ssm_parameter" "legacy_db_config_username" {
  name = "/${var.environment_name}/config/legacy_rds_username"
}
...
data "aws_ssm_parameter" "legacy_config_es_endpoint" {
  name = "/${var.environment_name}/config/legacy_es_endpoint"
}
...
locals {
  legacy_config_hostname = "${var.hostname=="" ? var.name : var.hostname}"
}
...
locals {
  legacy_config_protocol = "${data.aws_ssm_parameter.enable_https.value ? "https": "http" }"
  legacy_config_app_domain = "${data.aws_ssm_parameter.legacy_domain_name.value}"
  legacy_config_api_domain = "${data.aws_ssm_parameter.domain_prefix.value}.${data.aws_ssm_parameter.legacy_domain_name.value}"
...
module "routing" {
  ...
  protocol  = "${local.legacy_config_protocol}"
  hostname  = "${local.legacy_config_hostname}"
  port      = "${var.port}"
